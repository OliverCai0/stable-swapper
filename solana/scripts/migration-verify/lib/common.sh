...
DEPLOY_KEYPAIR="$SOLANA_DIR/target/deploy/scaas_liquidity-keypair.json"
LIB_RS="$SOLANA_DIR/programs/scaas-liquidity/src/lib.rs"
ANCHOR_TOML="$SOLANA_DIR/Anchor.toml"
LEGACY_COMMIT="3f5b5d8"
