...
export interface VerifyState {
  ...
  feeRecipient?: string;
  /** Throwaway mint minted by 05 to exercise listing/delisting; delisted before exit. */
  demoMint?: string;
  demoMintKeypairPath?: string;
  phase?: string;
}
...
export interface SmokeSignatures {
  ...
  configureListToken?: string | null;
  configureDelistToken?: string | null;
  configureUpdateFeeRate?: string | null;
  configureUpdateFeeRecipient?: string | null;
  hotUnpauseDenied?: string | null;
  hotWithdrawDenied?: string | null;
  hotAddPayoutDenied?: string | null;
  hotListTokenDenied?: string | null;
  hotUpdateFeeRateDenied?: string | null;
  hotUpdateFeeRecipientDenied?: string | null;
